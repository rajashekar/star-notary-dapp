...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(starsForSale[_tokenId1] > 0 && starsForSale[_tokenId2] > 0 ,"The Star's should be on sale to exchange");
        address ownerAddress1 = ownerOf(_tokenId1);
        address ownerAddress2 = ownerOf(_tokenId2);
        require(msg.sender == ownerAddress1 || msg.sender == ownerAddress2, "You should be the owner of the start to transfer");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address ownerAddress = ownerOf(_tokenId); 
        require(msg.sender == ownerAddress, "You should be the owner of star to transfer");
